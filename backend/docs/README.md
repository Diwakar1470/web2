...
# Go to: Services > MySQL > Start
# Or use: net start MySQL80 (replace with your version)
```
...
- Database URI: `mysql://user:password@host:port/dbname` or `mysql+mysqlconnector://user:password@host:port/dbname`

## Data Storage

- Data is persisted in MySQL (not JSON files)
